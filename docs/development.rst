...
http://testservices.readthedocs.org/en/latest/

If you wish to contribute to this project, then you should fork the
repository found here:

https://github.com/simplistix/testservices/
...
a virtualenv and then install the package in editable form as follows::
  ...
  $ python3 -m venv ~/virtualenvs/testservices
  $ source ~/virtualenvs/testservices/bin/activate
...
and push to https://github.com/simplistix/testservices
